...
void atg__philox_key_fold_in(tensor *, tensor key, int64_t data);
void atg__philox_key_split(tensor *, tensor key, int64_t num_splits);
void atg__philox_normal(tensor *, tensor self, tensor key, double mean, double std);
void atg__philox_normal_(tensor *, tensor self, tensor key, double mean, double std);
void atg__philox_normal_out(tensor *, tensor out, tensor self, tensor key, double mean, double std);
void atg__philox_uniform(tensor *, tensor self, tensor key, double low, double high);
void atg__philox_uniform_(tensor *, tensor self, tensor key, double low, double high);
void atg__philox_uniform_out(tensor *, tensor out, tensor self, tensor key, double low, double high);
...
void atg__scaled_dot_product_attention_math_for_mps(tensor *, tensor query, tensor key, tensor value, tensor attn_mask, double dropout_p, int is_causal, tensor dropout_mask, double scale_v, uint8_t scale_null, int enable_gqa);
...
void atg__upsample_lanczos2d_aa(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, uint8_t scales_h_null, double scales_w_v, uint8_t scales_w_null);
void atg__upsample_lanczos2d_aa_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, uint8_t scales_h_null, double scales_w_v, uint8_t scales_w_null);
void atg__upsample_lanczos2d_aa_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, uint8_t scales_h_null, double scales_w_v, uint8_t scales_w_null);
void atg__upsample_lanczos2d_aa_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, uint8_t scales_h_null, double scales_w_v, uint8_t scales_w_null);
void atg__upsample_lanczos2d_aa_vec(tensor *, tensor input, int64_t *output_size_data, int output_size_len, int align_corners, double *scale_factors_data, int scale_factors_len);
