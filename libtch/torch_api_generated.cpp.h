...
void atg__cslt_sparse_mm(tensor *out__, tensor compressed_A, tensor dense_B, tensor bias, tensor alpha, int out_dtype, int transpose_result, int64_t alg_id, int64_t split_k, int64_t split_k_mode) {
  PROTECT(
    auto outputs__ = torch::_cslt_sparse_mm(*compressed_A, *dense_B, (bias ? *bias : torch::Tensor()), (alpha ? *alpha : torch::Tensor()), out_dtype < 0 ? c10::nullopt : c10::optional<at::ScalarType>(at::ScalarType(out_dtype)), (bool)transpose_result, alg_id, split_k, split_k_mode);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__cudnn_attention_backward(tensor *out__, tensor grad_out, tensor query, tensor key, tensor value, tensor out, tensor logsumexp, tensor philox_seed, tensor philox_offset, tensor attn_bias, tensor cum_seq_q, tensor cum_seq_k, int64_t max_q, int64_t max_k, double dropout_p, int is_causal, double scale_v, uint8_t scale_null) {
  PROTECT(
    auto outputs__ = torch::_cudnn_attention_backward(*grad_out, *query, *key, *value, *out, *logsumexp, *philox_seed, *philox_offset, *attn_bias, *cum_seq_q, *cum_seq_k, max_q, max_k, dropout_p, (bool)is_causal, scale_null ? c10::nullopt : c10::optional<double>(scale_v));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg__flash_attention_forward_no_dropout_inplace(tensor *out__, tensor out, tensor query, tensor key, tensor value, tensor cum_seq_q, tensor cum_seq_k, int64_t max_q, int64_t max_k, double dropout_p, int is_causal, int return_debug_mask, double scale_v, uint8_t scale_null, int64_t window_size_left_v, uint8_t window_size_left_null, int64_t window_size_right_v, uint8_t window_size_right_null, tensor seqused_k, tensor alibi_slopes, tensor block_table, int64_t num_splits_v, uint8_t num_splits_null) {
  PROTECT(
    auto outputs__ = torch::_flash_attention_forward_no_dropout_inplace(*out, *query, *key, *value, (cum_seq_q ? *cum_seq_q : torch::Tensor()), (cum_seq_k ? *cum_seq_k : torch::Tensor()), max_q, max_k, dropout_p, (bool)is_causal, (bool)return_debug_mask, scale_null ? c10::nullopt : c10::optional<double>(scale_v), window_size_left_null ? c10::nullopt : c10::optional<int64_t>(window_size_left_v), window_size_right_null ? c10::nullopt : c10::optional<int64_t>(window_size_right_v), (seqused_k ? *seqused_k : torch::Tensor()), (alibi_slopes ? *alibi_slopes : torch::Tensor()), (block_table ? *block_table : torch::Tensor()), num_splits_null ? c10::nullopt : c10::optional<int64_t>(num_splits_v));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__fused_adagrad_tensor_lr_(tensor *self_data, int self_len, tensor *grads_data, int grads_len, tensor *state_sums_data, int state_sums_len, tensor *state_steps_data, int state_steps_len, tensor lr, double lr_decay, double weight_decay, double eps, int maximize, tensor grad_scale, tensor found_inf) {
  PROTECT(
    torch::_fused_adagrad_(of_carray_tensor(self_data, self_len), of_carray_tensor(grads_data, grads_len), of_carray_tensor(state_sums_data, state_sums_len), of_carray_tensor(state_steps_data, state_steps_len), *lr, lr_decay, weight_decay, eps, (bool)maximize, (grad_scale ? *grad_scale : torch::Tensor()), (found_inf ? *found_inf : torch::Tensor()));
  )
}
...
void atg__fused_rms_norm(tensor *out__, tensor input, int64_t *normalized_shape_data, int normalized_shape_len, tensor weight, double eps_v, uint8_t eps_null) {
  PROTECT(
    auto outputs__ = torch::_fused_rms_norm(*input, torch::IntArrayRef(normalized_shape_data, normalized_shape_len), (weight ? *weight : torch::Tensor()), eps_null ? c10::nullopt : c10::optional<double>(eps_v));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg__grouped_mm(tensor *out__, tensor self, tensor mat2, tensor offs, tensor bias, int out_dtype) {
  PROTECT(
    auto outputs__ = torch::_grouped_mm(*self, *mat2, (offs ? *offs : torch::Tensor()), (bias ? *bias : torch::Tensor()), out_dtype < 0 ? c10::nullopt : c10::optional<at::ScalarType>(at::ScalarType(out_dtype)));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__philox_key_fold_in(tensor *out__, tensor key, int64_t data) {
  PROTECT(
    auto outputs__ = torch::_philox_key_fold_in(*key, data);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__philox_key_split(tensor *out__, tensor key, int64_t num_splits) {
  PROTECT(
    auto outputs__ = torch::_philox_key_split(*key, num_splits);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__philox_normal(tensor *out__, tensor self, tensor key, double mean, double std) {
  PROTECT(
    auto outputs__ = torch::_philox_normal(*self, *key, mean, std);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__philox_normal_(tensor *out__, tensor self, tensor key, double mean, double std) {
  PROTECT(
    auto outputs__ = torch::_philox_normal_(*self, *key, mean, std);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__philox_normal_out(tensor *out__, tensor out, tensor self, tensor key, double mean, double std) {
  PROTECT(
    auto outputs__ = torch::_philox_normal_out(*out, *self, *key, mean, std);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__philox_uniform(tensor *out__, tensor self, tensor key, double low, double high) {
  PROTECT(
    auto outputs__ = torch::_philox_uniform(*self, *key, low, high);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__philox_uniform_(tensor *out__, tensor self, tensor key, double low, double high) {
  PROTECT(
    auto outputs__ = torch::_philox_uniform_(*self, *key, low, high);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__philox_uniform_out(tensor *out__, tensor out, tensor self, tensor key, double low, double high) {
  PROTECT(
    auto outputs__ = torch::_philox_uniform_out(*out, *self, *key, low, high);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__scaled_dot_product_attention_math_for_mps(tensor *out__, tensor query, tensor key, tensor value, tensor attn_mask, double dropout_p, int is_causal, tensor dropout_mask, double scale_v, uint8_t scale_null, int enable_gqa) {
  PROTECT(
    auto outputs__ = torch::_scaled_dot_product_attention_math_for_mps(*query, *key, *value, (attn_mask ? *attn_mask : torch::Tensor()), dropout_p, (bool)is_causal, (dropout_mask ? *dropout_mask : torch::Tensor()), scale_null ? c10::nullopt : c10::optional<double>(scale_v), (bool)enable_gqa);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg__upsample_lanczos2d_aa(tensor *out__, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, uint8_t scales_h_null, double scales_w_v, uint8_t scales_w_null) {
  PROTECT(
    auto outputs__ = torch::_upsample_lanczos2d_aa(*self, torch::IntArrayRef(output_size_data, output_size_len), (bool)align_corners, scales_h_null ? c10::nullopt : c10::optional<double>(scales_h_v), scales_w_null ? c10::nullopt : c10::optional<double>(scales_w_v));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__upsample_lanczos2d_aa_backward(tensor *out__, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, uint8_t scales_h_null, double scales_w_v, uint8_t scales_w_null) {
  PROTECT(
    auto outputs__ = torch::_upsample_lanczos2d_aa_backward(*grad_output, torch::IntArrayRef(output_size_data, output_size_len), torch::IntArrayRef(input_size_data, input_size_len), (bool)align_corners, scales_h_null ? c10::nullopt : c10::optional<double>(scales_h_v), scales_w_null ? c10::nullopt : c10::optional<double>(scales_w_v));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__upsample_lanczos2d_aa_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, uint8_t scales_h_null, double scales_w_v, uint8_t scales_w_null) {
  PROTECT(
    auto outputs__ = torch::_upsample_lanczos2d_aa_backward_out(*grad_input, *grad_output, torch::IntArrayRef(output_size_data, output_size_len), torch::IntArrayRef(input_size_data, input_size_len), (bool)align_corners, scales_h_null ? c10::nullopt : c10::optional<double>(scales_h_v), scales_w_null ? c10::nullopt : c10::optional<double>(scales_w_v));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__upsample_lanczos2d_aa_out(tensor *out__, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, uint8_t scales_h_null, double scales_w_v, uint8_t scales_w_null) {
  PROTECT(
    auto outputs__ = torch::_upsample_lanczos2d_aa_out(*out, *self, torch::IntArrayRef(output_size_data, output_size_len), (bool)align_corners, scales_h_null ? c10::nullopt : c10::optional<double>(scales_h_v), scales_w_null ? c10::nullopt : c10::optional<double>(scales_w_v));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__upsample_lanczos2d_aa_vec(tensor *out__, tensor input, int64_t *output_size_data, int output_size_len, int align_corners, double *scale_factors_data, int scale_factors_len) {
  PROTECT(
    auto outputs__ = torch::_upsample_lanczos2d_aa(*input, output_size_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(output_size_data, output_size_len)), (bool)align_corners, at::ArrayRef<double>(scale_factors_data, scale_factors_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__weight_int4pack_mm_with_scales_and_zeros(tensor *out__, tensor self, tensor mat2, int64_t qGroupSize, tensor qScale, tensor qZeros) {
  PROTECT(
    auto outputs__ = torch::_weight_int4pack_mm_with_scales_and_zeros(*self, *mat2, qGroupSize, *qScale, *qZeros);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_addmm_dtype(tensor *out__, tensor self, tensor mat1, tensor mat2, int out_dtype) {
  PROTECT(
    auto outputs__ = torch::addmm(*self, *mat1, *mat2, at::ScalarType(out_dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_addmm_dtype_out(tensor *out__, tensor out, tensor self, tensor mat1, tensor mat2, int out_dtype) {
  PROTECT(
    auto outputs__ = torch::addmm_out(*out, *self, *mat1, *mat2, at::ScalarType(out_dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_baddbmm_dtype(tensor *out__, tensor self, tensor batch1, tensor batch2, int out_dtype, scalar beta, scalar alpha) {
  PROTECT(
    auto outputs__ = torch::baddbmm(*self, *batch1, *batch2, at::ScalarType(out_dtype), *beta, *alpha);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_baddbmm_dtype_out(tensor *out__, tensor out, tensor self, tensor batch1, tensor batch2, int out_dtype) {
  PROTECT(
    auto outputs__ = torch::baddbmm_out(*out, *self, *batch1, *batch2, at::ScalarType(out_dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_bmm_dtype(tensor *out__, tensor self, tensor mat2, int out_dtype) {
  PROTECT(
    auto outputs__ = torch::bmm(*self, *mat2, at::ScalarType(out_dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_bmm_dtype_out(tensor *out__, tensor out, tensor self, tensor mat2, int out_dtype) {
  PROTECT(
    auto outputs__ = torch::bmm_out(*out, *self, *mat2, at::ScalarType(out_dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_fbgemm_linear_fp16_weight_fp32_activation(tensor *out__, tensor input, tensor packed_weight, tensor bias) {
  PROTECT(
    auto outputs__ = torch::fbgemm_linear_fp16_weight_fp32_activation(*input, *packed_weight, (bias ? *bias : torch::Tensor()));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_fbgemm_linear_fp16_weight_fp32_activation_out(tensor *out__, tensor input, tensor packed_weight, tensor bias, tensor output) {
  PROTECT(
    auto outputs__ = torch::fbgemm_linear_fp16_weight_fp32_activation(*input, *packed_weight, (bias ? *bias : torch::Tensor()), *output);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
int64_t atg_get_device(tensor self) {
  PROTECT(
...
void atg_hash_tensor(tensor *out__, tensor self, int64_t *dim_data, int dim_len, int keepdim, int64_t mode) {
  PROTECT(
    auto outputs__ = torch::hash_tensor(*self, torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, mode);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_hash_tensor_out(tensor *out__, tensor out, tensor self, int64_t *dim_data, int dim_len, int keepdim, int64_t mode) {
  PROTECT(
    auto outputs__ = torch::hash_tensor_out(*out, *self, torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, mode);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_mm_dtype(tensor *out__, tensor self, tensor mat2, int out_dtype) {
  PROTECT(
    auto outputs__ = torch::mm(*self, *mat2, at::ScalarType(out_dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_mm_dtype_out(tensor *out__, tensor out, tensor self, tensor mat2, int out_dtype) {
  PROTECT(
    auto outputs__ = torch::mm_out(*out, *self, *mat2, at::ScalarType(out_dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_randint_like_tensor(tensor *out__, tensor self, tensor high) {
  PROTECT(
    auto outputs__ = torch::randint_like(*self, *high);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_randint_like_tensor_out(tensor *out__, tensor out, tensor self, tensor high) {
  PROTECT(
    auto outputs__ = torch::randint_like_out(*out, *self, *high);
    out__[0] = new torch::Tensor(outputs__);
  )
...
int64_t atg_storage_offset(tensor self) {
  PROTECT(
